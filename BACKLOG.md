...
This backlog tracks the development milestones for Phase 2 (Cybernetic Command Interface & Knowledge Hub) and future roadmap items.
...
## Phase 2 — v1.2 Cybernetic Command Interface & Knowledge Hub (Target: 4–6 weeks from build start)
...
- [x] **M5:** Cybernetic HUD UI build (`CaseHistoryDrawer`, past session re-opening with server-side narrative decryption [FR-15], in-UI hard deletion [FR-21], progressive-disclosure status strings including Supabase auto-pause waking handling [PRD §21.2]).
